...
type NextAuthOptions = {
  providers: Array<{
    ...
    authorize: (credentials: Record<string, string> | undefined, req: { query: Record<string, unknown> | undefined; body: Record<string, unknown> | undefined; headers: Record<string, unknown> | undefined; method: string }) => Promise<Record<string, unknown> | null>
  }>
